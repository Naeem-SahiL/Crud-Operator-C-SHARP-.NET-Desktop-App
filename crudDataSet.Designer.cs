...
namespace Crud_Operator {
    ...
    public partial class crudDataSet : global::System.Data.DataSet {
        ...
        public partial class employeesDataTable : global::System.Data.TypedTableBase<employeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public employeesRow AddemployeesRow(string Id, string Name, string Contact) {
...
namespace Crud_Operator.crudDataSetTableAdapters {
    ...
    public partial class employeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[employees] WHERE (([Id] = @Original_Id) AND ([Name] = @Origina" +
                "l_Name) AND ([Contact] = @Original_Contact))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[employees] ([Id], [Name], [Contact]) VALUES (@Id, @Name, @Cont" +
                "act);\r\nSELECT Id, Name, Contact FROM employees WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[employees] SET [Id] = @Id, [Name] = @Name, [Contact] = @Contact WHE" +
                "RE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Contact] = @Origin" +
                "al_Contact));\r\nSELECT Id, Name, Contact FROM employees WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Crud_Operator.Properties.Settings.Default.crudConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Contact FROM dbo.employees";
        ...
        public virtual int Fill(crudDataSet.employeesDataTable dataTable) {
        ...
        public virtual crudDataSet.employeesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            crudDataSet.employeesDataTable dataTable = new crudDataSet.employeesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(crudDataSet.employeesDataTable dataTable) {
